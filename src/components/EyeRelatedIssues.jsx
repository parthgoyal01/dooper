...
const SpecialitiesCardDetails = [
    ...
    {
        img: '/Assets/Healthconcernimages/Redness_of_eyes.png',
        tag: 'Redness of eyes'
    },
    {
        img: '/Assets/Healthconcernimages/itching_of_eyes.png',
        tag: 'Itching of eyes'
    },
    {
        img: '/Assets/Healthconcernimages/discharge_from_eye.png',
        tag: 'Discharge from eye'
    },
    {
        img: '/Assets/Healthconcernimages/watering_of_eyes.png',
        tag: 'Watering of eyes'
    },


];
export const eyeRelatedIssuesData = {
    name: "Eye Related Issues",
    tags: SpecialitiesCardDetails.map(card => card.tag),
};
const EyeRelatedIssues = ({ searchQuery }) =>{
    const [active, setActive] = useState(false);
    const sectionMatchesQuery = eyeRelatedIssuesData.name.toLowerCase().includes(searchQuery.toLowerCase());
    ...
    return(
        ...
        <div className="flex justify-center">
            <div className="bg-[#F5F6F7] text-center px-[15px] py-[6px] rounded-[5px] text-[#1A1C1F] w-[230px] text-[14px] font-semibold">Eye Related Issues</div>
        </div>
        ...
        <div className="flex justify-center ">
            <p className="bg-[#F5F6F7] text-center px-[15px] py-[6px] rounded-[5px] text-[#1A1C1F] w-[240px] font-semibold text-[12px]">Eye Related Issues</p>
        </div>
        {/* <div className="text-[24px] font-medium text-center mt-[10px]">Get On-demand Primary Healthcare</div> */}
...
export default EyeRelatedIssues;