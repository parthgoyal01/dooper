...
const SpecialitiesCardDetails = [
    ...
    {
      img: "/Assets/Healthconcernimages/Repeated_miscarriages.png",
      tag: "Repeated miscarriages",
    },
    {
      img: "/Assets/Healthconcernimages/IVF_related_query.png",
      tag: "IVF related query",
    },
    {
      img: "/Assets/Healthconcernimages/tubal_block.png",
      tag: "Tubal block",
    },
    {
      img: "/Assets/Healthconcernimages/IUI_related_query.png",
      tag: "IUI related query",
    },
];
export const fertilityRelatedProblemsData = {
    name: "Fertility Related Problems",
    tags: SpecialitiesCardDetails.map(card => card.tag),
};
const FertilityRelatedProblems = ({ searchQuery }) =>{
    const [active, setActive] = useState(false);
    const sectionMatchesQuery = fertilityRelatedProblemsData.name.toLowerCase().includes(searchQuery.toLowerCase());
    ...
    return(
        ...
        <div className="flex justify-center">
            <div className="bg-[#F5F6F7] text-center px-[15px] py-[6px] rounded-[5px] text-[#1A1C1F] w-[230px] text-[14px] font-semibold">Fertility Related Problems</div>
        </div>
        ...
        <div className="flex justify-center ">
            <p className="bg-[#F5F6F7] text-center px-[15px] py-[6px] rounded-[5px] text-[#1A1C1F] w-[240px] font-semibold text-[12px]">Fertility Related Problems</p>
        </div>
        {/* <div className="text-[24px] font-medium text-center mt-[10px]">Get On-demand Primary Healthcare</div> */}
...
export default FertilityRelatedProblems;
