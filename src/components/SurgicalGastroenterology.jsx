...
const SpecialitiesCardDetails = [
    ...
    {
        img: '/Assets/Healthconcernimages/Pancreatitis.png',
        tag: 'Pancreatitis'
    },
    {
        img: '/Assets/Healthconcernimages/Gastroesophageol_reflux.png',
        tag: 'Gastroesophageol reflux'
    },
    {
        img: '/Assets/Healthconcernimages/appendicitis.png',
        tag: 'Appendicitis'
    },
    {
        img: '/Assets/Healthconcernimages/inflammatory_bowel_disease.png',
        tag: 'Inflammatory bowel disease'
    },{
        img: '/Assets/Healthconcernimages/gall_bladder_disorders.png',
        tag: 'Gall bladder disorders'
    },
    {
        img: '/Assets/Healthconcernimages/anal_fissure.png',
        tag: 'Anal fissure'
    },
    {
        img: '/Assets/Healthconcernimages/anal_fistula.png',
        tag: 'Anal fistula'
    },


];
export const surgicalGastroenterologyData = {
    name: "Surgical Gastroenterology",
    tags: SpecialitiesCardDetails.map(card => card.tag),
};
const SurgicalGastroenterology = ({ searchQuery }) =>{
    const [active, setActive] = useState(false);
    const sectionMatchesQuery = surgicalGastroenterologyData.name.toLowerCase().includes(searchQuery.toLowerCase());
    ...
    return(
        ...
        <div className="flex justify-center">
            <div className="bg-[#F5F6F7] text-center px-[15px] py-[6px] rounded-[5px] text-[#1A1C1F] w-[230px] text-[14px] font-semibold">Surgical Gastroenterology</div>
        </div>
        ...
        <div className="flex justify-center ">
            <p className="bg-[#F5F6F7] text-center px-[15px] py-[6px] rounded-[5px] text-[#1A1C1F] w-[240px] font-semibold text-[12px]">Surgical Gastroenterology</p>
        </div>
        {/* <div className="text-[24px] font-medium text-center mt-[10px]">Get On-demand Primary Healthcare</div> */}
...
export default SurgicalGastroenterology;