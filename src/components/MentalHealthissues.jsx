...
const SpecialitiesCardDetails = [
    ...
    {
        img: '/Assets/Healthconcernimages/Depression.png',
        tag: 'Depression'
    },
    {
        img: '/Assets/Healthconcernimages/Anxiety.png',
        tag: 'Anxiety'
    },
    {
        img: '/Assets/Healthconcernimages/obsessive_compulsive_disorder.png',
        tag: 'Obsessive compulsive disorder '
    },
    {
        img: '/Assets/Healthconcernimages/stress.png',
        tag: 'Stress'
    },

];
export const mentalHealthIssuesData = {
    name: "Mental Health issues",
    tags: SpecialitiesCardDetails.map(card => card.tag),
};
const MentalHealthissues = ({ searchQuery }) =>{
    const [active, setActive] = useState(false);
    const sectionMatchesQuery = mentalHealthIssuesData.name.toLowerCase().includes(searchQuery.toLowerCase());
    ...
    return(
        ...
        <div className="flex justify-center">
            <div className="bg-[#F5F6F7] text-center px-[15px] py-[6px] rounded-[5px] text-[#1A1C1F] w-[230px] text-[14px] font-semibold">Mental Health issues</div>
        </div>
        ...
        <div className="flex justify-center ">
            <p className="bg-[#F5F6F7] text-center px-[15px] py-[6px] rounded-[5px] text-[#1A1C1F] w-[240px] font-semibold text-[12px]">Mental Health issues</p>
        </div>
        {/* <div className="text-[24px] font-medium text-center mt-[10px]">Get On-demand Primary Healthcare</div> */}
