...
const SpecialitiesCardDetails = [
    ...
    {
        img: '/Assets/Healthconcernimages/Stiff_joints.png',
        tag: 'Stiff joints'
    },
    {
        img: '/Assets/Healthconcernimages/joint_swelling.png',
        tag: 'Joint swelling'
    },
    {
        img: '/Assets/Healthconcernimages/redness_over_the_joint.png',
        tag: 'Redness over the joint'
    },
    {
        img: '/Assets/Healthconcernimages/vasculitis.png',
        tag: 'Vasculitis'
    },


];
export const rheumatologyData = {
    name: "Rheumatology",
    tags: SpecialitiesCardDetails.map(card => card.tag),
};
const Rheumatology = ({ searchQuery }) =>{
    const [active, setActive] = useState(false);
    const sectionMatchesQuery = rheumatologyData.name.toLowerCase().includes(searchQuery.toLowerCase());
    ...
    return(
        ...
        <div className="flex justify-center">
            <div className="bg-[#F5F6F7] text-center px-[15px] py-[6px] rounded-[5px] text-[#1A1C1F] w-[230px] text-[14px] font-semibold">Rheumatology</div>
        </div>
        ...
        <div className="flex justify-center ">
            <p className="bg-[#F5F6F7] text-center px-[15px] py-[6px] rounded-[5px] text-[#1A1C1F] w-[240px] font-semibold text-[12px]">Rheumatology</p>
        </div>
        {/* <div className="text-[24px] font-medium text-center mt-[10px]">Get On-demand Primary Healthcare</div> */}
