...
const SpecialitiesCardDetails = [
    ...
    {
        img: '/Assets/Healthconcernimages/Pain_Ejaculation.png',
        tag: 'Pain ejaculation'
    },
    {
        img: '/Assets/Healthconcernimages/premature_ejaculation.png',
    ...
    {
        img: '/Assets/Healthconcernimages/decreased_sexual_drive.png',
        tag: 'Decreased sexual drive'
    },

];
export const maleSexualHealthData = {
    name: "Male Sexual Health",
    tags: SpecialitiesCardDetails.map(card => card.tag),
};
const MalesexualHealth = ({ searchQuery }) =>{
    const [active, setActive] = useState(false);
    const sectionMatchesQuery = maleSexualHealthData.name.toLowerCase().includes(searchQuery.toLowerCase());
    ...
    return(
        ...
        <div className="flex justify-center">
            <div className="bg-[#F5F6F7] text-center px-[15px] py-[6px] rounded-[5px] text-[#1A1C1F] w-[230px] text-[14px] font-semibold">Male Sexual Health</div>
        </div>
        ...
        <div className="flex justify-center ">
            <p className="bg-[#F5F6F7] text-center px-[15px] py-[6px] rounded-[5px] text-[#1A1C1F] w-[240px] font-semibold text-[12px]">Male Sexual Health</p>
        </div>
        {/* <div className="text-[24px] font-medium text-center mt-[10px]">Get On-demand Primary Healthcare</div> */}
...
export default MalesexualHealth;